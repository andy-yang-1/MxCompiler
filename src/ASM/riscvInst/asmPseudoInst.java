...
public class asmPseudoInst extends asmInst {
    ...
    public asmReg rs1 ;
    public String pseudoToken ;
    public asmPseudoInst( asmReg temp_rd , asmReg temp_rs1 , String tempInst ){
        rd = temp_rd ;
        rs1 = temp_rs1 ;
        pseudoToken = tempInst ;
    }
    ...
    public String toString() {
        ...
        tempStr += pseudoToken + " " + tmp_rd.toString() + ", " + tmp_rs1.toString() ;
        if ( rd instanceof addressReg ){
            tempStr += "\n\t" ;
