...
public class asmStoreInst extends asmInst{
    ...
    public String toString() {
        ...
        physicalReg tmp_rs2 , tmp_rs1 = new physicalReg(null,"t1") ;
...
//            return tempStr ;
        } else if ( baseRegPtr instanceof addressReg && ((addressReg) baseRegPtr).isStatic ){ // physical reg
            tempStr += killImmediate(new asmImme(-((addressReg) baseRegPtr).offset),tmp_rs1,new physicalReg(null,"s0"),tmp_rs1) + "\n\t" ;
